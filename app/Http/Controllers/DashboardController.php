    ...
    public function index()
    {
        ...
        $recentActivities = [
            [
                ...
                'description' => 'Shipment #SP-2025-001 has been created for order #1234',
            ...
            [
                ...
                'description' => 'Shipment #SP-2024-998 has been delivered to customer',
            ...
            [
                ...
                'description' => 'Tracking details updated for shipment #SP-2024-999',
            ...
            [
                ...
                'type' => 'order_shipped',
                'title' => 'Order shipped',
                'description' => 'Order #1235 has been shipped via Express Delivery',
                'created_at' => date('Y-m-d H:i:s', strtotime('-1 day')),
                'created_by' => 'Admin'
            ],
            [
                ...
                'description' => 'Status changed to "In Transit" for shipment #SP-2024-997',
            ...
            [
                ...
                'description' => 'Shipment #SP-2024-996 has been cancelled due to customer request',
