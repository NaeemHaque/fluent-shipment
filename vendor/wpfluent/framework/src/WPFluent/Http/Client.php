...
use FluentShipment\Framework\Http\Request\File;
...
class Client
{
	 ...
	 * @param  string $url
	 * @param  array  $args
	 * @return \FluentShipment\Framework\Http\Response
	 */
     ...
     *
     * @param  array $response
     * @return \FluentShipment\Framework\Http\Response|null
     */
	 ...
	 * 
	 * @param  string $url
	 * @return \FluentShipment\Framework\Http\Request\File
	 * @throws \Exception
	 */
