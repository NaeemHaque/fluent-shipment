...
namespace FluentShipment\Framework\Validator;
...
use FluentShipment\Framework\Validator\Rules\In;
use FluentShipment\Framework\Validator\Rules\NotIn;
use FluentShipment\Framework\Validator\Rules\Unique;
use FluentShipment\Framework\Validator\Rules\Exists;
use FluentShipment\Framework\Validator\Rules\RequiredIf;
use FluentShipment\Framework\Validator\Rules\Dimensions;
use FluentShipment\Framework\Validator\Rules\ConditionalRules;
...
class Rule
{
     ...
     * @return \FluentShipment\Framework\Validator\Rules\ConditionalRules
     */
     ...
     * @return \FluentShipment\Framework\Validator\Rules\Dimensions
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentShipment\Framework\Validator\Rules\Exists
     */
     ...
     *
     * @param  \FluentShipment\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentShipment\Framework\Validator\Rules\In
     */
     ...
     *
     * @param  \FluentShipment\Framework\Support\ArrayableInterface|array|string  $values
     * @return \FluentShipment\Framework\Validator\Rules\NotIn
     */
     ...
     * @return \FluentShipment\Framework\Validator\Rules\RequiredIf
     */
     ...
     * @param  string  $table
     * @param  string  $column
     * @return \FluentShipment\Framework\Validator\Rules\Unique
     */
