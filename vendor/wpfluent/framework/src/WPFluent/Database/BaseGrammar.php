...
abstract class BaseGrammar
{
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Expression|string  $table
     * @return string
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Expression|string|int|float  $expression
