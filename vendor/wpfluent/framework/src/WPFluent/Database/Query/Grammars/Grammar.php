...
namespace FluentShipment\Framework\Database\Query\Grammars;

use RuntimeException;
use FluentShipment\Framework\Support\Arr;
use FluentShipment\Framework\Support\Helper;
use FluentShipment\Framework\Database\BaseGrammar;
use FluentShipment\Framework\Database\Query\Builder;
use FluentShipment\Framework\Database\Query\Expression;
use FluentShipment\Framework\Database\Query\JoinClause;
use FluentShipment\Framework\Database\Query\JoinLateralClause;
use FluentShipment\Framework\Database\Concerns\CompilesJsonPaths;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\JoinLateralClause  $join
