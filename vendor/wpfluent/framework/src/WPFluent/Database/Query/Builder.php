...
use FluentShipment\Framework\Foundation\App;
use FluentShipment\Framework\Support\Arr;
use FluentShipment\Framework\Support\Str;
use FluentShipment\Framework\Support\Helper;
use FluentShipment\Framework\Support\MacroableTrait;
use FluentShipment\Framework\Support\Collection;
use FluentShipment\Framework\Pagination\Paginator;
use FluentShipment\Framework\Support\ForwardsCalls;
use FluentShipment\Framework\Support\LazyCollection;
use FluentShipment\Framework\Database\Query\Expression;
use FluentShipment\Framework\Database\Query\Grammars\Grammar;
use FluentShipment\Framework\Database\Query\Processors\Processor;
use FluentShipment\Framework\Database\Query\ConditionExpression;
use FluentShipment\Framework\Support\ArrayableInterface;
use FluentShipment\Framework\Database\ConnectionInterface;
use FluentShipment\Framework\Database\Concerns\BuildsQueries;
use FluentShipment\Framework\Database\Concerns\BuildsWhereDateClauses;
use FluentShipment\Framework\Database\Concerns\ExplainsQueries;
use FluentShipment\Framework\Database\Orm\Relations\Relation;
use FluentShipment\Framework\Database\Orm\Builder as OrmBuilder;
...
class Builder
{
     ...
     *
     * @var \FluentShipment\Framework\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \FluentShipment\Framework\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \FluentShipment\Framework\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @var \FluentShipment\Framework\Database\Query\IndexHint
     */
    public $indexHint;
     ...
     *
     * @param  \FluentShipment\Framework\Database\ConnectionInterface  $connection
     * @param  \FluentShipment\Framework\Database\Query\Grammars\Grammar|null  $grammar
     * @param  \FluentShipment\Framework\Database\Query\Processors\Processor|null  $processor
     * @return void
     */
     ...
     *
     * @param  \Closure|\FluentShipment\Framework\Database\Query\Builder|\FluentShipment\Framework\Database\Orm\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\FluentShipment\Framework\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Closure|\FluentShipment\Framework\Database\Query\Builder|string  $table
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \FluentShipment\Framework\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  string  $table
     * @return \FluentShipment\Framework\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\FluentShipment\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Expression|string  $column
     * @param  string  $value
     ...
     *
     * @param  string  $column
     * @param  \FluentShipment\Framework\Support\ArrayableInterface|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|\FluentShipment\Framework\Database\Query\Expression  $column
     * @param  array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @return \FluentShipment\Framework\Database\Query\Builder
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Expression[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  \Closure|\FluentShipment\Framework\Database\Orm\Builder|\FluentShipment\Framework\Database\Query\Builder|\FluentShipment\Framework\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\FluentShipment\Framework\Database\Query\Builder|\FluentShipment\Framework\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return mixed
     *
     * @throws \FluentShipment\Framework\Database\RecordsNotFoundException
     * @throws \FluentShipment\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  \FluentShipment\Framework\Support\Collection  $items
     * @return \FluentShipment\Framework\Support\Collection
     */
     ...
     * @return \FluentShipment\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentShipment\Framework\Pagination\PaginatorInterface
     */
     ...
     * @param  \FluentShipment\Framework\Pagination\Cursor|string|null  $cursor
     * @return \FluentShipment\Framework\Pagination\CursorPaginatorInterface
     */
     ...
     *
     * @return \FluentShipment\Framework\Support\LazyCollection
     */
     ...
     *
     * @param  mixed  $value
     * @return \FluentShipment\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\ConnectionInterface
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\Query\Grammars\Grammar
     */
