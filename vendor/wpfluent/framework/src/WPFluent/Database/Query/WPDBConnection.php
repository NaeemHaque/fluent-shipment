...
use FluentShipment\Framework\Database\QueryException;
use FluentShipment\Framework\Database\ConnectionInterface;
use FluentShipment\Framework\Database\MultipleColumnsSelectedException;
use FluentShipment\Framework\Database\Events\QueryExecuted;
use FluentShipment\Framework\Database\Query\Expression;
use FluentShipment\Framework\Database\Query\Processors\Processor;
use FluentShipment\Framework\Database\Query\Processors\MySqlProcessor;
use FluentShipment\Framework\Database\Query\Processors\SQLiteProcessor;
...
use FluentShipment\Framework\Database\Query\Grammars\SQLiteGrammar;
use FluentShipment\Framework\Database\Concerns\ManagesTransactions;
use FluentShipment\Framework\Database\DetectsLostConnections;

use FluentShipment\Framework\Database\Events\TransactionBeginning;
use FluentShipment\Framework\Database\Events\TransactionCommitted;
use FluentShipment\Framework\Database\Events\TransactionCommitting;
use FluentShipment\Framework\Database\Events\TransactionRolledBack;
...
class WPDBConnection implements ConnectionInterface
{
     ...
     *
     * @var \FluentShipment\Framework\Database\DatabaseTransactionsManager|null
     */
     ...
     * @return mixed
     *
     * @throws \FluentShipment\Framework\Database\MultipleColumnsSelectedException
     */
     ...
     * @param bool $useReadPdo
     * @return \Generator
     * @throws \FluentShipment\Framework\Database\QueryException
     */
     ...
     *
     * @param \FluentShipment\Framework\Database\Query\Grammars\Grammar $grammar
     * @return $this
     */
     ...
     *
     * @param \FluentShipment\Framework\Database\Query\Processors\Processor $processor
     * @return $this
     */
