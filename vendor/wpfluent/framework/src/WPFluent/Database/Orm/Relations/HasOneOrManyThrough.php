...
use FluentShipment\Framework\Database\Orm\SoftDeletes;
...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentShipment\Framework\Database\Orm\Model| \FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \FluentShipment\Framework\Database\Orm\Model|\FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
