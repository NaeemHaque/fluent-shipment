...
namespace FluentShipment\Framework\Database\Orm\Relations;
...
use FluentShipment\Framework\Database\Orm\ModelNotFoundException;
use FluentShipment\Framework\Database\Query\Grammars\MySqlGrammar;
use FluentShipment\Framework\Database\Orm\Relations\Concerns\AsPivot;
use FluentShipment\Framework\Database\UniqueConstraintViolationException;
use FluentShipment\Framework\Database\Orm\Relations\Concerns\InteractsWithDictionary;
use FluentShipment\Framework\Database\Orm\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\FluentShipment\Framework\Database\Query\Expression>
     */
     ...
     *
     *
     * @param  \FluentShipment\Framework\Database\Orm\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\FluentShipment\Framework\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|null
     */
     ...
     * @param  array  $columns
     * @return \FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>
     */
     ...
     * @return \FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     *
     * @throws \FluentShipment\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @return \FluentShipment\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|TValue
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentShipment\Framework\Pagination\Paginator
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \FluentShipment\Framework\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\Orm\Builder<TRelatedModel>
     */
     ...
     *
     * @return \FluentShipment\Framework\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \FluentShipment\Framework\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Builder<TRelatedModel>  $query
     * @param  \FluentShipment\Framework\Database\Orm\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\FluentShipment\Framework\Database\Query\Expression  $column
     * @return string|\FluentShipment\Framework\Database\Query\Expression
     */
