...
namespace FluentShipment\Framework\Database\Orm\Relations\Concerns;
...
trait CanBeOneOfMany
{
     ...
     *
     * @var \FluentShipment\Framework\Database\Orm\Builder|null
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Builder  $parent
     * @param  \FluentShipment\Framework\Database\Orm\Builder  $subQuery
     * @param  string  $on
     * @return void
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\Orm\Builder|void
     */
