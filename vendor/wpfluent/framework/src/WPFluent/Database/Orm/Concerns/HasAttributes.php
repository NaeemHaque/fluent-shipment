...
use FluentShipment\Framework\Support\DateTime;
use FluentShipment\Framework\Support\ArrayableInterface;
use FluentShipment\Framework\Database\Orm\Casts\Attribute;
use FluentShipment\Framework\Database\Orm\Castable;
use FluentShipment\Framework\Database\Orm\Casts\AsCollection;
use FluentShipment\Framework\Database\Orm\Casts\AsArrayObject;
use FluentShipment\Framework\Database\Orm\Relations\Relation;
use FluentShipment\Framework\Database\Orm\InvalidCastException;
use FluentShipment\Framework\Database\Orm\JsonEncodingException;
use FluentShipment\Framework\Database\LazyLoadingViolationException;
use FluentShipment\Framework\Database\Orm\CastsInboundAttributes;
use FluentShipment\Framework\Support\Collection as BaseCollection;
use FluentShipment\Framework\Database\Orm\MissingAttributeException;
...
trait HasAttributes
{
     ...
     *
     * @var \FluentShipment\Framework\Encryption\Encrypter
     */
     ...
     * @return null
     *
     * @throws \FluentShipment\Framework\Database\Orm\MissingAttributeException
     */
     ...
     *
     * @param  \FluentShipment\Framework\Encryption\Encrypter  $encrypter
     * @return void
     */
     ...
     *
     * @param  mixed  $value
     * @return \FluentShipment\Framework\Support\DateTime;
     */
     ...
     * @return bool
     *
     * @throws \FluentShipment\Framework\Database\Orm\InvalidCastException
     */
