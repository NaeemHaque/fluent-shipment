...
use FluentShipment\Framework\Support\UrlRoutable;
use FluentShipment\Framework\Support\JsonableInterface;
use FluentShipment\Framework\Support\ArrayableInterface;
use FluentShipment\Framework\Support\HelperFunctionsTrait;
use FluentShipment\Framework\Support\CanBeEscapedWhenCastToString;
use FluentShipment\Framework\Support\Collection as BaseCollection;
...
use FluentShipment\Framework\Database\Orm\Collection as OrmCollection;
use FluentShipment\Framework\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayableInterface, ArrayAccess, CanBeEscapedWhenCastToString, JsonableInterface, JsonSerializable, UrlRoutable
{
     ...
     *
     * @var \FluentShipment\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @var \FluentShipment\Framework\Events\Dispatcher
     */
     ...
     * @return $this
     *
     * @throws \FluentShipment\Framework\Database\Orm\MassAssignmentException
     */
     ...
     *
     * @param  string|null  $connection
     * @return \FluentShipment\Framework\Database\Orm\Builder
     */
     ...
     *
     * @param  \FluentShipment\Framework\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Builder  $builder
     * @return \FluentShipment\Framework\Database\Orm\Builder
     */
     ...
     * @return \FluentShipment\Framework\Database\Orm\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \FluentShipment\Framework\Database\Orm\JsonEncodingException
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @return \FluentShipment\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \FluentShipment\Framework\Database\Orm\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \FluentShipment\Framework\Database\Orm\Model  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \FluentShipment\Framework\Database\Orm\Builder
     */
