...
namespace FluentShipment\Framework\Database\Orm;
...
use FluentShipment\Framework\Support\HelperFunctionsTrait;
use FluentShipment\Framework\Database\Query\Expression;
use FluentShipment\Framework\Database\Concerns\BuildsQueries;
use FluentShipment\Framework\Database\RecordsNotFoundException;
use FluentShipment\Framework\Database\Orm\Relations\Relation;
use FluentShipment\Framework\Database\Orm\Relations\BelongsToMany;
use FluentShipment\Framework\Database\Orm\RelationNotFoundException;
use FluentShipment\Framework\Database\Orm\Concerns\QueriesRelationships;
use FluentShipment\Framework\Database\UniqueConstraintViolationException;
use FluentShipment\Framework\Database\Query\Builder as QueryBuilder;

/**
 * @property-read HigherOrderBuilderProxy $orWhere
 *
 * @mixin \FluentShipment\Framework\Database\Query\Builder
 *
 * @template TModel of \FluentShipment\Framework\Database\Orm\Model
 */
class Builder
{
     ...
     *
     * @var \FluentShipment\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentShipment\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @return \FluentShipment\Framework\Database\Orm\Model|static
     */
     ...
     * @param  \FluentShipment\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \FluentShipment\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\FluentShipment\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\FluentShipment\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\FluentShipment\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \FluentShipment\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentShipment\Framework\Database\Orm\Model|\FluentShipment\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  \FluentShipment\Framework\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \FluentShipment\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentShipment\Framework\Database\Orm\Model|\FluentShipment\Framework\Database\Orm\Collection|static|static[]
     *
     * @throws \FluentShipment\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @return TModel|TValue|\FluentShipment\Framework\Database\Orm\Collection
     */
     ...
     * @return \FluentShipment\Framework\Database\Orm\Model|static|mixed
     */
     ...
     * @return \FluentShipment\Framework\Database\Orm\Model
     *
     * @throws \FluentShipment\Framework\Database\Orm\ModelNotFoundException
     ...
     * @return mixed
     *
     * @throws \FluentShipment\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \FluentShipment\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \FluentShipment\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \FluentShipment\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @return \FluentShipment\Framework\Pagination\LengthAwarePaginator
     *
     ...
     * @return \FluentShipment\Framework\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array  $attributes
     * @return \FluentShipment\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Orm\Model  $model
     * @return $this
     */
     ...
     *
     * @param  array|\FluentShipment\Framework\Database\Query\Expression  $columns
     * @return array
     */
