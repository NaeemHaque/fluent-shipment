...
use FluentShipment\Framework\Container\Container;
...
use FluentShipment\Framework\Support\Conditionable;
...
use FluentShipment\Framework\Database\MultipleRecordsFoundException;
use FluentShipment\Framework\Pagination\Cursor;
use FluentShipment\Framework\Pagination\Paginator;
use FluentShipment\Framework\Pagination\CursorPaginator;
use FluentShipment\Framework\Pagination\LengthAwarePaginator;

/**
 * @template TValue
 *
 * @mixin \FluentShipment\Framework\Database\Orm\Builder
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\FluentShipment\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \FluentShipment\Framework\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  \FluentShipment\Framework\Database\Query\Builder|\FluentShipment\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  \FluentShipment\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \FluentShipment\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \FluentShipment\Framework\Pagination\CursorPaginator
     */
