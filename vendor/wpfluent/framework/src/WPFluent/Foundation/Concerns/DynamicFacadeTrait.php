...
namespace FluentShipment\Framework\Foundation\Concerns;

use FluentShipment\Framework\Support\Facade;
...
trait DynamicFacadeTrait
{
     ...
     *
     * @param  string $facade Facade namespace prefix (e.g., FluentShipment\Framework\Facade)
