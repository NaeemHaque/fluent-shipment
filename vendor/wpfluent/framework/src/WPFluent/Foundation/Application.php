...
use FluentShipment\Framework\Support\Env;
use FluentShipment\Framework\Http\Client;
use FluentShipment\Framework\Foundation\Config;
use FluentShipment\Framework\Container\Container;
use FluentShipment\Framework\Foundation\ComponentBinder;
use FluentShipment\Framework\Foundation\Concerns\FoundationTrait;

/**
 * @property \FluentShipment\Framework\Foundation\Config $config
 * @property \FluentShipment\Framework\Http\Router\Router $router
 * @property \FluentShipment\Framework\Http\Request\Request $request
 * @property \FluentShipment\Framework\Http\Response\Response $response
 */
class Application extends Container
{
     ...
     * 
     * @param \FluentShipment\Framework\Http\Router $router
     * 
     * @return void
     */
